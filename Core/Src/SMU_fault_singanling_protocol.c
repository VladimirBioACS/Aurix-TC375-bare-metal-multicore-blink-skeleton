/**
**********************************************************************************************************************
*    @file           : SMU_fault_signaling_protocol.c
*    @brief          : SMU_fault_signaling_protocol setup source file
...
static Ifx_SMU_FSP_Bits get_FSP_timing_settings(uint8 minFaultStateTime);
...
/**
* @brief initialize the SMU fault signal protocol
* @param argument: None
* @retval None
*/
...
/**
* @brief function to calculate the PRE1 and TFSP_HIGH bitfields of the FSP register for the given minimum fault state time
* @param argument: uint8 minFaultStateTime
* @retval None
*/
static Ifx_SMU_FSP_Bits get_FSP_timing_settings(uint8 minFaultStateTime)
{
...
/**
* @brief trigger an Alarm and execute the FSP protocol
* @param argument: None
* @retval None
*/
void run_FSP_Protocol(void)
{
    ...
    {
        /* indicate the alarm is triggered */
        printnl("Trigger Software Alarm 0");
    ...
    {
        /* indicate that release FSP command is sent */
        printnl("Call releaseFSP command to switch to fault free state run");
    ...
    /* FSP is switched to fault free state */
    printnl("FSP is switched to fault free state");
}

/**
* @brief waits until a timeout in milliseconds
* @param argument: uint32 ms
* @retval None
*/
static void wait_ms(uint32 ms)
{
